# -*- coding: utf-8 -*-
"""
CSM V3 -- HMI Module 10 -- Mast Base Socket V1.2 Drawing Generator
==================================================================
Multi-view engineering drawing for the V1.2 STL.

Output:
  CSM_V3_MastBaseSocket_V1_2_views.png
  CSM_V3_MastBaseSocket_V1_2_views.pdf
...
STL_PATH = os.path.join(HERE, "CSM_V3_MastBaseSocket_V1_2.stl")
...
fig.suptitle('CSM V3 -- HMI Module 10 -- Mast Base Socket V1.2',
             fontsize=16, fontweight='bold', y=0.97)
fig.text(0.5, 0.94, 'Larger gussets, anti-creep ribs, R1.5 pocket fillets, '
                    'counterbore for socket-head, 10 mm foot',
...
ax_notes.text(0.02, 0.95, 'V1.2 IMPROVEMENTS', fontsize=10, fontweight='bold')
notes = [
...
fig.text(0.5, 0.02,
         ...
         'Module 10 part 1 of 10 (V1.2)',
         ha='center', fontsize=8, color='#888')

out_png = os.path.join(HERE, "CSM_V3_MastBaseSocket_V1_2_views.png")
out_pdf = os.path.join(HERE, "CSM_V3_MastBaseSocket_V1_2_views.pdf")
