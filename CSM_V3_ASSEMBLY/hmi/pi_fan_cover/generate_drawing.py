# -*- coding: utf-8 -*-
"""CSM V3 -- HMI Module 10 -- Pi Fan Cover V1.0 Drawing Generator"""
import os, struct
import numpy as np
...
STL_PATH = os.path.join(HERE, "CSM_V3_PiFanCover_V1_3.stl")
...
fig.suptitle('CSM V3 -- HMI Module 10 -- Pi Fan Cover V1.0',
             fontsize=16, fontweight='bold', y=0.97)
fig.text(0.5, 0.94, 'Active cooling for Pi 4: 30 x 30 x 10 mm fan, hangs below Pi PCB',
         ha='center', fontsize=10, color='#444', style='italic')

def setup_3d(ax, elev, azim, title):
    ax.add_collection3d(Poly3DCollection(triangles, facecolor='#6090c0',
                                          edgecolor='#1a2a4a',
...
dims = [
    ...
    ('Fan screws',    '4x M3'),
    ('Fan grille',    '5 capsules 3.5 x 22'),
...
ax_notes.text(0.02, 0.95, 'ASSEMBLY (after Pi Carrier mount)', fontsize=10, fontweight='bold')
notes = [
    '1. Print PETG flat, 100% infill, 4 walls',
    '2. Remove 4x M2.5 x 6 screws holding Pi to',
    '   Pi Carrier standoffs (keep standoffs in)',
...
fig.text(0.5, 0.02,
         ...
         'CSM_V3_ASSEMBLY/hmi/pi_fan_cover/  *  '
         'Module 10 part 4 of 10',
         ha='center', fontsize=8, color='#888')

out_png = os.path.join(HERE, "CSM_V3_PiFanCover_V1_3_views.png")
out_pdf = os.path.join(HERE, "CSM_V3_PiFanCover_V1_3_views.pdf")
