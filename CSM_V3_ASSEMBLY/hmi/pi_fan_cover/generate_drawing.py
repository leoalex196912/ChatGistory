...
STL_PATH = os.path.join(HERE, "CSM_V3_PiFanCover_V1_2.stl")
...
out_png = os.path.join(HERE, "CSM_V3_PiFanCover_V1_2_views.png")
out_pdf = os.path.join(HERE, "CSM_V3_PiFanCover_V1_2_views.pdf")
